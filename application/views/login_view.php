        ...
        <div class="col-xs-12 col-sm-8 col-md-6">
            <form role="form">
                ...
                <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            <input type="text" name="sex" id="sex" class="form-control input-lg" placeholder="Sex" tabindex="5">
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            <input type="date" name="date" id="date" class="form-control input-lg" placeholder="Enter birth day" tabindex="6">
                        </div>
                    </div>
                </div>
                <div class="row">
